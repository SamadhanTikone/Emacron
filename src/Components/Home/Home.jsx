...
export default function Home() {
  ...
  <>
    ...
    <div className="md:w-[80%] w-[80%] mt-[15%]">
      ...
      <h1 className={`md:text-6xl text-4xl  w-full md:mx-12 md:mt-1 my-16 ${styles.heading} text-right uppercase md:pl-4 font-bold`}> Turning Your <span className="text-[#363062]">Vision</span> into <span className="text-[#363062]">Reality</span>.</h1>
