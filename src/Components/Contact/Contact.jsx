...
export default function Contact() {
  return (
    <>
    <div className="bg-[url(./hero-bg.png)] h-full text-black pt-[15%]">
...
<Button variant="outlined" sx={{borderColor:"#363062", color:"#363062", margin:"10px 2px"}} >contact</Button>
...
<div className="flex flex-col md:flex-row justify-around md:gap-1 gap-4 items-center">
...
<img src="./icons/telephone (1).png" alt="" className=" md:w-12 w-8  absolute" />
